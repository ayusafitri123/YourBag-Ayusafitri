...
<!-- Header -->
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <h2>YourBag</h2>
                <img class ="img1 mt-5" src="frontend/img/Group 31.png" alt="">
    ...
    <div class="container">
        <div class="row ml-auto">
            <div class="col-5">
              <img class="pic2" src="frontend/img/Group 25.png" alt="">
            </div>
            ...
            <div class="col-5">
                <form>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="formGroupExampleInput2" placeholder="No. Phone">
                    </div>
                  </form>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-4 text-center">
              <a href="index4.html">
                <button type="button" class="btn btn-warning btn-lg btn-block">Continue to Book</button>
              </a>
            </div>  
        </div> 
    </div>
